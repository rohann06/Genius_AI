  ...
  const NavOptions = [
    {
      ...
      upprtDivStyle: "p-3 bg-violet-200/40 rounded-lg",
    ...
    },
    {
      ...
      link: "/imageGenerator",
      icon: <LuImage />,
      upprtDivStyle: "p-3 bg-fuchsia-200/40 rounded-lg",
    ...
    },
    {
      ...
      link: "/videoGenerator",
      icon: <LuVideo />,
      upprtDivStyle: "p-3 bg-green-200/40 rounded-lg",
    ...
    },
    {
      ...
      link: "/musicGenerator",
      icon: <LuMusic />,
      upprtDivStyle: "p-3 bg-orange-200/40 rounded-lg",
    ...
    },
    {
      ...
      link: "/codeGenerator",
      icon: <LuCode2 />,
      upprtDivStyle: "p-3 bg-teal-200/40 rounded-lg",
  ...
  return (
    <div>
      <div className=" space-y-4 my-6 text-center">
        ...
        <p className=" text-lg text-gray-400 font-Rubik">
          Embark on a journey to explore the incredible power of AI.
        </p>
      </div>
      <div className=" flex flex-col md:gap-y-6 w-full mt-10">
